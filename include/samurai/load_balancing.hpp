...
namespace samurai
{
    ...
    class LoadBalancer
    {
      private:
        ...
        void update_fields(Mesh_t& new_mesh) const
        {
        }
...
// void perform_load_balancing_diffusion( AMesh_t & global, int ndomains,  const std::vector<MPI_Load_Balance> & all, Field_t &
// fake_mpi_rank ) {
