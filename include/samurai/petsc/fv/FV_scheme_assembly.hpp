    ...
    namespace petsc
    {
        ...
        class FVSchemeAssembly : public MatrixAssembly
        {
          ...
          public:
            ...
            {
                return static_cast<PetscInt>(m_n_cells * output_field_components);
            }

            PetscInt matrix_cols() const override
            {
                return static_cast<PetscInt>(m_n_cells * field_components);
            }
            ...
            inline PetscInt col_index(PetscInt cell_index, [[maybe_unused]] unsigned int field_j) const
            {
                ...
                {
                    return m_col_shift + cell_index * static_cast<PetscInt>(field_components) + static_cast<PetscInt>(field_j);
                }
            }
            ...
            inline PetscInt row_index(PetscInt cell_index, [[maybe_unused]] unsigned int field_i) const
            {
                ...
                {
                    return m_row_shift + cell_index * static_cast<PetscInt>(output_field_components) + static_cast<PetscInt>(field_i);
                }
            }
            ...
            void assemble_prediction_1D(Mat& A)
            {
                ...
                samurai::for_each_prediction_ghost(
                    ...
                    [&](auto& ghost)
                    {
                        ...
                        double scaling = 1. / (h * h);
                        for (unsigned int field_i = 0; field_i < field_components; ++field_i)
                        {
