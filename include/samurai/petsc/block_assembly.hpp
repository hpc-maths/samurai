...
namespace samurai
{
    namespace petsc
    {
         ...
         * auto result_velocity_mono = samurai::make_vector_field<dim>("result_velocity", mesh);
         ...
         * auto result_velocity_nest = samurai::make_vector_field<dim>("result_velocity", mesh);
