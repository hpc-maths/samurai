...
namespace samurai
{
    ...
    class LastDimProjectionTraverser;

    template <class SetTraverser>
    struct SetTraverserTraits<LastDimProjectionTraverser<SetTraverser>>
    {
    ...
    template <class SetTraverser>
    class LastDimProjectionTraverser : public SetTraverserBase<LastDimProjectionTraverser<SetTraverser>>
    {
        using Self = LastDimProjectionTraverser<SetTraverser>;

      public:

        SAMURAI_SET_TRAVERSER_TYPEDEFS

        LastDimProjectionTraverser(const SetTraverser& set_traverser, const ProjectionType projectionType, const std::size_t shift)
      ...
      private:
        ...
        SAMURAI_INLINE void next_interval_coarsen()
        {
