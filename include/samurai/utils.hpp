...
// class OrthGivensMatrixVectorProd
//{
//   public:
//
//     OrthGivensMatrixVectorProd() = default;
//
//     OrthGivensMatrixVectorProd(const size_t i, const size_t j)
//         : m_i(i)
//         , m_j(j)
//     {
//     }
...
//     xt::xtensor_fixed<T, xt::xshape<N>> operator()(const xt::xtensor_fixed<T, xt::xshape<N>>& x) const
//     {
//         xt::xtensor_fixed<T, xt::xshape<N>> y(x);
//         y[m_i] = -x[m_j];
//         y[m_j] = x[m_i];
//
//         return y;
...
//     xt::xtensor<typename xt::xfunction<Ts...>::value_type, 1> operator()(const xt::xfunction<Ts...>& x) const
//     {
//         xt::xtensor<typename xt::xfunction<Ts...>::value_type, 1> y(x);
//         y[m_i] = -x[m_j];
//         y[m_j] = x[m_i];
//
//         return y;
...
// inline Function forall_orth_givens_rotations(std::integral_constant<size_t, dim>, Function&& func)
//{
//     static_assert(dim > 1, "there is no givens rotations in 1D");
//
//     OrthGivensMatrixVectorProd G;
...
// inline Function forall_orth_givens_rotations(size_t dim, Function&& func)
//{
//     assert(dim > 1);
//
//     OrthGivensMatrixVectorProd G;
...
//
// template <size_t dim, typename Function>
// inline Function forall_unit_vectors(std::integral_constant<size_t, dim>, Function&& func)
//{
//     using vector = xt::xtensor_fixed<int, xt::xshape<dim>>;
//
//     vector v;
//     for (size_t i = 0; i != dim; ++i)
//     {
...
//
// template <typename Function>
// inline Function forall_unit_vectors(size_t dim, Function&& func)
//{
