...
namespace samurai
{
    ...
    class LocalField<field_t, std::enable_if_t<field_t::nb_components == 1>>
    {
    ...
    class LocalField<field_t, std::enable_if_t<field_t::nb_components != 1>>
    {
        using field_value_type    = typename field_t::value_type;
        using cell_t              = typename field_t::cell_t;
        using container_t         = decltype(xt::adapt(std::declval<const field_value_type*>(), xt::xshape<field_t::nb_components>()));
      ...
      public:
        ...
        LocalField(const cell_t& cell, const field_value_type* data)
            : m_cell(cell)
            , m_container(container_closure_t(data, xt::detail::fixed_compute_size<xt::xshape<field_t::nb_components>>::value))
        {
        }
