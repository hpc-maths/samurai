...
namespace samurai
{
    ...
    class OperatorSum
    {
      private:
        ...
        template <SchemeType scheme_type_, std::size_t stencil_size_, std::size_t output_field_components_>
        struct Config
        {
      ...
      public:
        ...
        static constexpr std::size_t output_field_components = FirstOperatorType::cfg_t::output_field_components;
        ...
        using cfg_t = Config<scheme_type_of_sum<Operators...>(), stencil_size_of_sum<Operators...>(), output_field_components>;
      ...
      public:
        ...
        {
            static constexpr bool all_output_field_components_are_same = std::conjunction_v<
                std::integral_constant<bool, Operators::cfg_t::output_field_components == output_field_components>...>;
            static_assert(all_output_field_components_are_same, "Cannot add operators with different output field sizes.");
        }

        explicit OperatorSum(const std::tuple<Operators...>& operator_tuple)
            : m_operators(operator_tuple)
        {
            // static constexpr bool all_output_field_componentss_are_same = std::conjunction_v<
            //     std::integral_constant<bool, Operators::cfg_t::output_field_components == output_field_components>...>;
            // static_assert(all_output_field_componentss_are_same, "Cannot add operators with different output field sizes.");
        }
