...
namespace samurai
{
    ...
    class compute_detail_op : public field_operator_base<TInterval> {
      public:
        ...
        {
            auto qs_i = Qs_i<1>(field, level, i, j, k);
            auto qs_j = Qs_j<1>(field, level, i, j, k);
            auto qs_k = Qs_k<1>(field, level, i, j, k);

            auto qs_ij = Qs_ij<1>(field, level, i, j, k);
            auto qs_ik = Qs_ik<1>(field, level, i, j, k);
            auto qs_jk = Qs_jk<1>(field, level, i, j, k);

            auto qs_ijk = Qs_ijk<1>(field, level, i, j, k);
