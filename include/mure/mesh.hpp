...
namespace mure
{
    ...
    public:
        ...
        using mesh_t = mure::MeshIDArray<ca_type, mesh_id_t>;
    ...
    protected:
        ...
        Mesh_base(const mure::Box<double, dim>& b, std::size_t start_level, std::size_t min_level, std::size_t max_level);
    ...
    template<class D, class Config>
    inline Mesh_base<D, Config>::Mesh_base(const mure::Box<double, dim>& b, std::size_t start_level, std::size_t min_level, std::size_t max_level)
