...
namespace mure
{
    ...
    class MRMesh: public mure::Mesh_base<MRMesh<Config>, Config>
    {
    public:
        using base_type = mure::Mesh_base<MRMesh<Config>, Config>;
        ...
        MRMesh(const mure::Box<double, dim>& b, std::size_t min_level, std::size_t max_level);
    ...
    template <class Config>
    inline MRMesh<Config>::MRMesh(const mure::Box<double, dim>& b, std::size_t min_level, std::size_t max_level)
...
template <>
struct fmt::formatter<mure::MRMeshId>: formatter<string_view>
{
    // parse is inherited from formatter<string_view>.
    template <typename FormatContext>
    auto format(mure::MRMeshId c, FormatContext& ctx) {
        string_view name = "unknown";
        switch (c) {
        case mure::MRMeshId::cells:            name = "cells"; break;
        case mure::MRMeshId::cells_and_ghosts: name = "cells and ghosts"; break;
        case mure::MRMeshId::proj_cells:       name = "projection cells"; break;
        case mure::MRMeshId::union_cells:      name = "union cells"; break;
        case mure::MRMeshId::overleaves:       name = "overleaves"; break;
        case mure::MRMeshId::all_cells:        name = "all cells"; break;
        }
