...
namespace mure
{
                                                            ...
                                                            const interval_t &interval, const T... index) const -> const interval_t&
    {
        ...
        {
            spdlog::critical("{} FIELD ERROR on level {} for interval_tmp {} and interval {}",
                             rw, level, interval_tmp, interval);
        }
        return interval_tmp;
    }
    ...
    {
        auto interval_tmp = get_interval("WRITE", level, interval, index...);
