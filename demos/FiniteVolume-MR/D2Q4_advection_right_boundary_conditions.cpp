...
void one_time_step_overleaves_corrected(Field &f, const pred& pred_coeff, std::size_t iter)
{
    ...
    for (std::size_t level = min_level; level <= max_level; ++level)
    {
        ...
        else
        {
            ...
            auto overleaves_east = intersection(get_adjacent_boundary_east(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);

            auto overleaves_northeast = intersection(get_adjacent_boundary_northeast(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);

            auto overleaves_southeast = intersection(get_adjacent_boundary_southeast(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);
            ...
            auto overleaves_west = intersection(get_adjacent_boundary_west(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);

            auto overleaves_northwest = intersection(get_adjacent_boundary_northwest(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);

            auto overleaves_southwest = intersection(get_adjacent_boundary_southwest(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);
            ...
            auto overleaves_south = intersection(get_adjacent_boundary_south(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);

            auto overleaves_north = intersection(get_adjacent_boundary_north(mesh, lev_p_1, samurai::MeshType::overleaves),
                                                mesh[samurai::MeshType::cells][level]);
                        ...
                        double eps, std::size_t ite, std::string ext="")
{
    ...
    samurai::Field<Config, double, 4> f_reconstructed("f_reconstructed", init_mesh, bc);
    f_reconstructed.array().fill(0.);

    samurai::Field<Config> rho_reconstructed{"rho_reconstructed", init_mesh};
    samurai::Field<Config> rho{"rho", init_mesh};
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        else
        {
            ...
            samurai::Mesh<Config> mesh_ref{box, max_level, max_level};
