...
int main(int argc, char* argv[])
{
    ...
    static constexpr std::size_t field_components = 1;
    ...
    // Reaction operator
    using cfg  = samurai::LocalCellSchemeConfig<samurai::SchemeType::NonLinear, field_components, decltype(u)>;
    ...
    auto rhs = samurai::make_field<field_components>("rhs", mesh);
