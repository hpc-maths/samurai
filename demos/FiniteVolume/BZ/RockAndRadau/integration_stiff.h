...
void rock4_integration(double tini, double tend, int neq, /*double *uini, */double *u,
                       func_rock fcn, double tol, int *info);

void rock4_integration_history(double tini, double tend, int neq, double *uini, double *u,
                               func_rock fcn, double tol, double *dt_rock, int *info);

#ifdef __cplusplus
extern "C" {
#endif
void radau5_(int *n, func_radau fcn, double *x, double *y, double *xend, double *h,
...
void rock4_(int *n, double *t, double *tend, double *dt, double *u,
