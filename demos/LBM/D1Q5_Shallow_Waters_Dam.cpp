            ...
            double s_rel, const double lambda, const double g)
{
    ...
    for (std::size_t level = 0; level <= max_level; ++level)    {
        ...
        leaves([&](auto &interval, auto) {
            ...
            auto h = xt::eval(advected_f(0, level, i) + advected_f(1, level, i) + advected_f(2, level, i) +     advected_f(3, level, i) +     advected_f(4, level, i));
            auto q = xt::eval(lb1 * (                   advected_f(1, level, i) - advected_f(2, level, i) + 2.* advected_f(3, level, i) - 2.* advected_f(4, level, i)));
            auto k = xt::eval(lb2 * (                   advected_f(1, level, i) + advected_f(2, level, i) + 4.* advected_f(3, level, i) + 4.* advected_f(4, level, i)));
            auto v = xt::eval(lb3 * (                   advected_f(1, level, i) - advected_f(2, level, i) + 8.* advected_f(3, level, i) - 8.* advected_f(4, level, i)));
            auto z = xt::eval(lb4 * (                   advected_f(1, level, i) + advected_f(2, level, i) + 16.*advected_f(3, level, i) + 16.*advected_f(4, level, i)));
...
{
    cxxopts::Options options("lbm_d1q5_shallow waters",
                             "...");
