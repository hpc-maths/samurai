...
std::array<double, 6> compute_error(samurai::Field<Config, double, 3> &f, FieldR & fR,
        ...
        else
        {
            ...
            for (auto s : s_vect)   {
                ...
                std::cout<<std::endl<<"Testing time behavior"<<std::endl;
                {
                    ...
                    out_error_h_exact_ref.open ("./d1q3/time/"+prefix+"E_h.dat");
                    out_error_h_exact_adap.open ("./d1q3/time/"+prefix+"e_h.dat");
                    out_diff_h_ref_adap.open   ("./d1q3/time/"+prefix+"delta_h.dat");
                    out_error_q_exact_ref.open ("./d1q3/time/"+prefix+"E_q.dat");
                    out_error_q_exact_adap.open ("./d1q3/time/"+prefix+"e_q.dat");
                    out_diff_q_ref_adap.open   ("./d1q3/time/"+prefix+"delta_q.dat");
                ...
                std::cout<<std::endl<<"Testing eps behavior"<<std::endl;
                {
                    ...
                    out_diff_h_ref_adap.open   ("./d1q3/eps/"+prefix+"delta_h.dat");
                    out_diff_q_ref_adap.open   ("./d1q3/eps/"+prefix+"delta_q.dat");
                    out_compression.open     ("./d1q3/eps/"+prefix+"comp.dat");
                    out_compression_avg.open     ("./d1q3/eps/"+prefix+"comp_avg.dat");
